from VideoClassification.utils.DBTools.MySqlTools.dbSQL import CREATE_TABLE_VideoSets_SQL, CREATE_VIDEO_LABELS_SQL, \
    CREATE_TABLE_ImgSets_SQL, INSERT_NEW_IMAGE, INSERT_VIDEO_LABELS
...
def InsertIntoImageSets():
    filepath = '/workspace/personal_data/data/buckelist.txt'
