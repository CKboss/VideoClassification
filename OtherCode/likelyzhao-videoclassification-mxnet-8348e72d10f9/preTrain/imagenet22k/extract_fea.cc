...
const mx_float DEFAULT_MEAN_R = 117;
const mx_float DEFAULT_MEAN_G = 117;
const mx_float DEFAULT_MEAN_B = 117;
...
int main(int argc, char* argv[]) {
    ...
    std::string json_file = "model/Inception-symbol.json";
    std::string param_file = "model/Inception-0009.params";
    std::string synset_file = "model/synset.txt";
    std::string nd_file = "";
    std::string fea_path = "/workspace/data_out/trainval2/";
